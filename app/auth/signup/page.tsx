  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8">
      <div className="w-full max-w-md text-center">
        ...
        {/* Info Card */}
        <div className="bg-card rounded-2xl p-8 border border-border shadow-lg space-y-6">
          <div>
        ...
        {/* Form Card */}
        <div className="bg-card rounded-2xl p-8 border border-border shadow-lg mt-8">
          <h2 className="text-2xl font-bold text-foreground mb-2">Create Account</h2>
          <p className="text-muted-foreground text-sm mb-6">Join thousands of construction teams</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-start gap-2 cursor-pointer">
              <input type="checkbox" className="rounded mt-1 border-input bg-background" required />
